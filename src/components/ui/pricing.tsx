  ...
  return (
    <div className="container-px mx-auto max-w-6xl py-20">
      <div className="mb-12 space-y-4 text-center">
        <h2 className="font-heading text-4xl tracking-tight sm:text-5xl">{title}</h2>
        <p className="whitespace-pre-line text-lg text-muted">{description}</p>
      </div>
        ...
        {plans.map((plan, index) => (
          ...
          >
            ...
            <div className="flex flex-1 flex-col">
              ...
              <p className="mt-6 text-xs leading-5 text-muted">{plan.description}</p>
            </div>
          </motion.div>
        ))}
      </div>
