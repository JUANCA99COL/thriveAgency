...
import { SiBehance, SiGithub, SiInstagram } from "@icons-pack/react-simple-icons";
...
// Simple Icons removed LinkedIn's mark at the trademark holder's request, so
// there's no accurate official glyph to import — this is a neutral monogram
// badge instead of a guessed/faked logo path.
...
const highlights: Highlight[] = [
  {
    title: "Case studies",
    description:
      "Branding, UI/UX, and web design for tech startups, e-commerce, and creative brands — from tattoo studio identity to recruitment platforms.",
  },
  {
    title: "Experience",
    description:
  ...
  {
    title: "Availability",
    description: "Open for freelance projects and collaborations · Remote-friendly.",
  },
];
...
const socialLinks: SocialLink[] = [
  {
    label: "Instagram",
    handle: "@thrive_designz",
    href: social.instagram,
    icon: SiInstagram,
  },
  {
    label: "Behance",
    handle: "juanrodriguez24",
    href: social.behance,
    icon: SiBehance,
  },
  {
...
export function GlassmorphismPortfolioBlock() {
  return (
    <section id="founder" className="relative overflow-hidden px-6 py-24 lg:py-32">
          ...
          <div className="relative grid gap-12 lg:grid-cols-2">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                >
                  Founder & Product Designer at Thrive Design
                </motion.h2>
                <motion.p
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                  Camilo leads design at Thrive Design — a studio built for tech
                  startups and founders who need premium web experiences.
                  You see it, we build it: interfaces that pair UX craft with
                  brand-level polish, from first wireframe to launch.
                </motion.p>
              </div>
              ...
              >
                <Button
                  size="lg"
                  onClick={() => window.open(social.behance, "_blank")}
            ...
            <div className="relative">
              ...
              <div className="relative flex h-full flex-col justify-between overflow-hidden rounded-[28px] border border-border/50 bg-background/60 p-8 backdrop-blur-xl">
                <div className="flex flex-col items-center text-center">
                  ...
                  >
                    Partnering with founders and product teams to design
                    interfaces that feel considered from pixel to interaction.
                  </motion.p>
                </div>
